...
class PreCheckinController with MessageStateMixin {
  ...
  Future<void> next() async {
    ...
    debugPrint("🚀 ~ PreCheckinController ~ Future<void>next ~ $result");

    switch (result) {
      case Left():
        showError('Erro ao chamar paciente');
      case Right(value: final form?): // se o form não for nulo
      debugPrint("🚀 ~ PreCheckinController ~ Future<void>next ~ $form");
